...
namespace Org.System.Xml.Sax {
  ...
  public class Constants {
    ...
    /// <summary>Standard SAX feature name. See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/package-summary.html#package_description'>Feature
    /// table</see> on www.saxproject.org.</summary>
    public const string NamespacesFeature = Features + "namespaces",
    ...
    /// <seealso
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/Locator2.html'>Locator2
    /// on www.saxproject.org</seealso>
    /// <summary>True if parser provides implementations for the
    /// <see cref='ILocator.XmlVersion'/> and
    /// <see cref='ILocator.Encoding'/> properties, false
    /// otherwise.</summary>
    /// <remarks>Read-only. Replaces the UseLocator2Feature feature in SAX
    /// for .NET 1.0.</remarks>
    public const string XmlDeclFeature = Features + "xml-declaration";

    /// <seealso
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/EntityResolver2.html'>EntityResolver2
    /// on www.saxproject.org</seealso>
    /// <summary>True if parser calls back on
    /// <see cref='IEntityResolver.GetExternalSubset'/> to process an
    /// application-provided DTD, false if no such call-back is
    /// made.</summary>
    ...
    /// <remarks>Read-only. If false, then calling
    /// <see cref='IXmlReader.Suspend'/>,
    /// <see cref='IXmlReader.Resume'/> or
    /// <see cref='IXmlReader.Abort'/> will throw a
    ...
    /// <summary>Standard SAX property name. See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/package-summary.html#package_description'>Property
    /// table</see> on www.saxproject.org.</summary>
    public const string XmlStringProperty = Properties + "xml-string",
      DomNodeProperty = Properties + "dom-node";

    /// <summary>Interface GUID constant for COM interop.</summary>
    public const string IidIAttributes = "B88C9D0F-1AFD-412A-B9EF-2313AB251CF1",
    ...
    public const char XmlColon = ':';
  }

  /**<summary>See <see
    href="http://www.saxproject.org/apidoc/org/xml/sax/Attributes.html" >
   * Attributes</see> and <see
  href="http://www.saxproject.org/apidoc/org/xml/sax/ext/Attributes2.html" >
   * Attributes2</see> on www.saxproject.org.</summary>
   * <remarks>
   * This interface combines features from the <c>Attributes</c> and
     <c>Attributes2</c>
   * interfaces specified in the original Java SAX API.
   * <list type="bullet">
   * <item>Some methods behave differently from Java - check method
     documentation.</item>
   * <item>Outside of the <see cref="IContentHandler.StartElement" />
     call-back, an
   * <c>IAttributes</c> instance is not required to return meaningful
     information.
   * It will depend on the implementation if the instance is a unique object
     retaining all
   * information, if accessing it throws a <see cref="SaxException" />, or
     if it returns
  ...
  public interface IAttributes
  {
    ...
    /// range.</exception>
    /// <remarks>
    /// <para>returns the empty string if there is no namespace for the
    /// attribute name.</para> Differences to Java:
    /// <list type='bullet'>
    /// <item>Throws standard .NET exceptions.</item></list></remarks>
    ...
    /// <item>Always returns a non-empty string
    /// value.</item></list></remarks>
    ...
    /// <list type='bullet'>
    /// <item>Throws standard .NET exceptions.</item>
    /// <item>Allows for two additional return values, <c>"ENUMERATION"</c>
    /// when the attribute is an enumerated type, and <c>"UNDECLARED"</c>
    /// when no declaration for the attribute has been read. The latter
    /// replaces
    /// <see
    ...
    /// <overloads>Returns index of specified attribute, or -1 if the
    /// attribute does not exist.</overloads>
    /// <summary>See
    /// <see
   ...
   * <remarks>The order of events in this interface must mirror the order of
     information
   * in a well-formed XML document, but it is not necessary that the
     call-backs are generated
  ...
  public interface IContentHandler
  {
    ...
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ContentHandler.html#startDocument()'>ContentHandler.startDocument</see>
    /// on www.saxproject.org.</summary>
    /// <remarks>Differences to Java:
    /// <list type='bullet'>
    /// <item>Stricter about when to call: For a stream of SAX events that
    /// represent an XML document, the SAX event producer must call
    /// <c>StartDocument</c> exactly once, <b>before</b> any part of the
    /// input, on which the SAX events are based, is
    /// processed.</item></list></remarks>
    void StartDocument();

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ContentHandler.html#endDocument()'>ContentHandler.endDocument</see>
    /// on www.saxproject.org.</summary>
    /// <remarks>Differences to Java:
    /// <list type='bullet'>
    /// <item>Stricter about when to call: <c>EndDocument</c><b>must</b> be
    /// called by the SAX event producer exactly once as the last event in
    /// a SAX event stream if it was initiated by a
    /// <see cref='IContentHandler.StartDocument'/> call, regardless of any
    /// exceptions or errors encountered, even after
    /// <see cref='IXmlReader.Abort'/> was called. Depending on the call
    /// communication mechanism, however, this is no guarantee that the SAX
    /// event consumer will also receive the call.</item></list></remarks>
    void EndDocument();

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ContentHandler.html#startPrefixMapping(java.lang.String,
    /// java.lang.String)'>ContentHandler.startPrefixMapping</see> on
    /// www.saxproject.org.</summary>
    ...
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ContentHandler.html#startElement(java.lang.String,
    /// java.lang.String, java.lang.String,
    /// org.xml.sax.Attributes)'>ContentHandler.startElement</see> on
    /// www.saxproject.org.</summary>
    /// <remarks>
    /// <para>If there is no URI, then the <c>uri</c> argument will be the
    /// empty string and not <c>null</c>. This can be the case when
  ...
  IAttributes atts);
    ...
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ContentHandler.html#endElement(java.lang.String,
    /// java.lang.String,
    ...
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ContentHandler.html#characters(char[],
    /// int, int)'>ContentHandler.characters</see> on
    /// www.saxproject.org.</summary>
    void Characters(char[] ch, int start, int length);

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ContentHandler.html#ignorableWhitespace(char[],
    /// int, int)'>ContentHandler.ignorableWhitespace</see> on
    /// www.saxproject.org.</summary>
    void IgnorableWhitespace(char[] ch, int start, int length);

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ContentHandler.html#processingInstruction(java.lang.String,
    /// java.lang.String)'>ContentHandler.processingInstruction</see> on
    /// www.saxproject.org.</summary>
  ...
  public interface IDtdHandler
  {
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/DTDHandler.html#notationDecl(java.lang.String,
    /// java.lang.String, java.lang.String)'>DTDHandler.notationDecl</see>
    /// on www.saxproject.org.</summary>
    void NotationDecl(string name, string publicId, string systemId);

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/DTDHandler.html#unparsedEntityDecl(java.lang.String,
    /// java.lang.String, java.lang.String,
  ...
  /**<summary>See <see
    href="http://www.saxproject.org/apidoc/org/xml/sax/ext/DeclHandler.html"
    >
  ...
  public interface IDeclHandler {
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/DeclHandler.html#elementDecl(java.lang.String,
    /// java.lang.String)'>DeclHandler.elementDecl</see> on
    /// www.saxproject.org.</summary>
    void ElementDecl(string name, string model);

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/DeclHandler.html#attributeDecl(java.lang.String,
  ...
  string valueAValue);
    ...
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/DeclHandler.html#internalEntityDecl(java.lang.String,
    /// java.lang.String)'>DeclHandler.internalEntityDecl</see> on
    /// www.saxproject.org.</summary>
    void InternalEntityDecl(string name, string value);

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/DeclHandler.html#externalEntityDecl(java.lang.String,
    /// java.lang.String,
    /// java.lang.String)'>DeclHandler.externalEntityDecl</see> on
    /// www.saxproject.org.</summary>
    void ExternalEntityDecl(string name, string publicId, string systemId);
  }

  /**<summary>See <see
  href="http://www.saxproject.org/apidoc/org/xml/sax/ext/LexicalHandler.html"
    >
  ...
  public interface ILexicalHandler {
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/LexicalHandler.html#startDTD(java.lang.String,
    /// java.lang.String, java.lang.String)'>LexicalHandler.startDTD</see>
    /// on www.saxproject.org.</summary>
    void StartDtd(string name, string publicId, string systemId);

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/LexicalHandler.html#endDTD()'>LexicalHandler.endDTD</see>
    /// on www.saxproject.org.</summary>
    void EndDtd();
    ...
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/LexicalHandler.html#startCDATA()'>LexicalHandler.startCDATA</see>
    /// on www.saxproject.org.</summary>
    void StartCData();

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/LexicalHandler.html#endCDATA()'>LexicalHandler.endCDATA</see>
    /// on www.saxproject.org.</summary>
    void EndCData();

    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/LexicalHandler.html#comment(char[],
    /// int, int)'>LexicalHandler.comment</see> on
    /// www.saxproject.org.</summary>
    void Comment(char[] ch, int start, int length);
  }

  /**<summary>See <see
    href="http://www.saxproject.org/apidoc/org/xml/sax/EntityResolver.html"
    >
   * EntityResolver</see> and <see
  href="http://www.saxproject.org/apidoc/org/xml/sax/ext/EntityResolver2.html"
     >
   * EntityResolver2</see> on www.saxproject.org.</summary>
   * <remarks>This interface combines features from the
  ...
  public interface IEntityResolver {
    ...
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/ext/EntityResolver2.html#resolveEntity(java.lang.String,
    /// java.lang.String, java.lang.String,
   ...
   * <remarks><para>It is <b>not</b> prohibited to call back on this
     interface from any of the
   * call-back handlers, like <see cref="IContentHandler" /> and <see
     cref="ILexicalHandler" />.
   * This allows, for example, that a schema validator implemented as <see
     cref="IXmlFilter" />
   * can properly report validation errors through the <c>IErrorHandler</c>
     call-backs.</para>
   * Differences to Java:
   * <list type="bullet">
   * <item>The arguments passed to the call-backs are not <see
     cref="SaxParseException" />
   * objects, but instances of (a sub-class of) <see cref="ParseError" />.
     The reason for
   * this is that using exception objects would require the creation of a
     new instance
   * for each call-back, as an exception's standard properties can only be
     set in the
   * constructor. This is quite inefficient when error call-backs happen
     frequently.</item>
   * <item>To be re-usable, the <see cref="ParseError" /> arguments are only
     valid for the
  ...
  public interface IErrorHandler
  {
    ...
    /// violations. Parser cannot continue. See
    /// <see
    ...
    /// <summary>Describes the kind of entity that is being
    /// parsed.</summary>
    /// <remarks>For document entities, the* declared* rather than the
    /// effective value of the standalone flag is reported.</remarks>
  public enum ParsedEntityType
  {
    /// <summary>Type of entity not known (at this time).</summary>
    Unknown,

    /// <summary>Document entity without specified value for the standalone
    /// flag.</summary>
    Document,
  ...
  /**<summary>See <see
    href="http://www.saxproject.org/apidoc/org/xml/sax/Locator.html" >
   * Locator</see> and <see
     href="http://www.saxproject.org/apidoc/org/xml/sax/ext/Locator2.html" >
   * Locator2</see> on www.saxproject.org.</summary>
   * <remarks>
   * <list type="bullet">
   * <item>This interface combines features from the <c>Locator</c> and
     <c>Locator2</c>
   * interfaces specified in the original Java SAX API.</item>
   * <item>Any call on this interface before <see
  ...
  public enum XmlReaderStatus
  {
    ...
    /// <remarks>Should only be detectable from within a call-back
    /// handler.</remarks>
    Parsing,

    /// <summary>Parsing of input source is suspended, but not completed
    /// yet.</summary>
    /// <remarks>Parsing can be resumed again - or aborted.</remarks>
    Suspended
  }

  /**<summary><c>IXmlReader</c> is the interface that an XML parser
    confomring to the SAX
   * API must implement. This interface allows an application to set and
     query features
   ...
   * these methods - as reported by the <c>reader-control</c> feature - it
     is only
   * required to support their functionality for content related call-backs,
     but not
   * for DTD related events. This capability allows one to turn a SAX parser
     into a
 ...
 * <seealso
  ...
  public interface IXmlReader
  {
    ...
    /// <summary>See
    /// <see
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/XMLReader.html#setFeature(java.lang.String,
    /// boolean)'>XMLReader.setFeature</see> on
    /// www.saxproject.org.</summary>
    /// <exception cref='ArgumentException'>Thrown when the feature name is
    /// not recognized (
    /// <see cref='ArgumentException.ParamName'/> = <c>"name"</c> ) or when
    /// the feature value is not accepted (
    /// <see cref='ArgumentException.ParamName'/> = <c>"value"</c>
    /// ).</exception>
    /// <exception cref='NotSupportedException'>Thrown when the feature
    /// cannot be set.</exception>
    /// <remarks>Differences to Java:
    /// <list type='bullet'>
    /// <item>Throws standard .NET exceptions.</item></list></remarks>
    ...
    /// <seealso
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/XMLReader.html#getProperty(java.lang.String)'>XMLReader.getProperty
    /// on www.saxproject.org</seealso>
    /// <summary>Returns an
    ...
    /// <list type='bullet'>
    /// <item>Throws standard .NET exceptions.</item>
    /// <item>The actual property value is accessed through
    /// <see cref='IProperty&lt;T>.Value'/>.</item></list></remarks>
    ...
    /// the end of parsing.</item></list></remarks>
    void Parse(InputSource input);

    /// <summary>Parses the XML document represented by the system
    /// identifier. See
    /// <see
    ...
    /// <exception cref='SaxException'>Thrown when called outside of
    /// call-back handler.</exception>
    /// <exception cref='NotSupportedException'>Thrown when not
    /// implemented.</exception>
    /// <remarks>
    /// <list type='bullet'>
    /// <item>Optional method.</item>
    /// <item>It is only legal to call <c>Suspend</c> when
    /// <see cref='IXmlReader.Status'/> has the value <c>Parsing</c>, and
    /// this should only be done from within a handler call-back.</item>
    /// <item>On return the
    /// <see cref='IXmlReader.Status'/> property will have the value
    /// <c>Suspended</c>.</item>
    /// <item>An implementation may decide to suspend parsing not
    /// immediately, but rather "as soon as possible" . This can for
    /// instance mean that, after calling <c>Suspend</c> from the
    /// <see cref='IContentHandler.StartElement'/> call-back of an empty
    /// element tag, the
    /// <see cref='IContentHandler.EndElement'/> call-back may still
    /// follow.</item></list></remarks>
    void Suspend();

    /// <summary>Causes parsing to stop with a fatal error.</summary>
    /// <exception cref='SaxException'>Thrown when called
    /// illegally.</exception>
    /// <exception cref='NotSupportedException'>Thrown when not
    /// implemented.</exception>
    /// <remarks>
    /// <list type='bullet'>
    /// <item>Optional method.</item>
    /// <item>It is legal to call <c>Abort</c> from within a handler
    /// call-back, that is, when
    /// <see cref='IXmlReader.Status'/> has the value <c>Parsing</c>, or
    /// from anywhere when parsing is suspended.</item>
    /// <item>On return from
    /// <see cref='IXmlReader.Resume'/> or
    /// <see cref='IXmlReader.Parse'/> the
    /// <see cref='IXmlReader.Status'/> property will have the value
    /// <c>Ready</c>.</item>
    /// <item>An implementation may decide to abort parsing not
    /// immediately, but rather "as soon as possible" . This can for
    /// instance mean that, after calling <c>Abort</c> from the
    /// <see cref='IContentHandler.StartElement'/> call-back of an empty
    /// element tag, the
    /// <see cref='IContentHandler.EndElement'/> call-back may still
    /// follow.</item></list></remarks>
    ...
    /// <summary>Resumes parsing as if
    /// <see cref='IXmlReader.Parse'/> continued with the same input source
    /// it was initially called with.</summary>
    /// <exception cref='SaxException'>Thrown when called
    /// illegally.</exception>
    /// <exception cref='NotSupportedException'>Thrown when not
    /// implemented.</exception>
    ...
    /// <list type='bullet'>
    /// <item>Optional method.</item>
    /// <item>It is only legal to call <c>Resume</c> when parsing is
    /// suspended, that is, when
    /// <see cref='IXmlReader.Status'/> has the value <c>Suspended</c>
    /// .</item>
    /// <item>The
    /// <see cref='IXmlReader.Status'/> property will have the value
    /// <c>Parsing</c> immediately afterwards (in the next handler
    /// call-back), but on return from <c>Resume</c> its value will either
    /// be <c>Ready</c> - when parsing is done - or <c>Suspended</c> - when
    /// parsing was suspended again.</item></list></remarks>
    void Resume();
  ...
  /**<summary>Base interface for <see cref="IXmlReader" /> property
    access.</summary>
   * <remarks>Does not exist in the Java SAX API. Using such an interface to
     access
...
* casting to the correct type occurs only once, on initial
 ...
 // //[GUID(Constants.IidIStringProperty), Obsolete]
   ...
   * <remarks>Because the <see cref="Org.System.Xml.Sax" >definition of
     "parsing" </see>
 ...
 return String.Empty;
    ...
    /// <seealso
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/SAXParseException.html#getExceptionId()'>SAXParseException.getExceptionId
    /// on www.saxproject.org</seealso>
 ...
 return null;
    ...
    /// <summary>Throws new
    /// <see cref='SaxParseException'/> based on this instance.</summary>
    public void Throw() {
...
* <remarks>The .NET <see cref="Exception" /> class already
  ...
  public class SaxParseException : SaxException
  {
    ...
    /// <value>The underlying ParseError instance, if any.</value>
 ...
 return this.error;
   ...
   * <remarks>Derive from this class to give specific access to input
     data.</remarks>
   * <seealso
 ...
 this.systemId = null;
   ...
   * <remarks>The source could be a <c>Stream</c> or <c>TextReader</c>. It
     will not
   * be disposed after use - that responsibility is left to the
     application.</remarks>
   * <seealso
     href="http://www.saxproject.org/apidoc/org/xml/sax/InputSource.html" >
   * InputSource on www.saxproject.org</seealso>
  ...
  public class InputSource<S> : InputSource
  {
    ...
    /// <seealso
    /// href='http://www.saxproject.org/apidoc/org/xml/sax/InputSource.html#setByteStream(java.io.InputStream)'>InputSource.get/setByteStream
    /// on www.saxproject.org</seealso>
    /// <summary>Gives access to the input data.</summary>
    /// <value>Gives access to the input data.</value>
    public S Source
    {
      get {
 return this.source;
