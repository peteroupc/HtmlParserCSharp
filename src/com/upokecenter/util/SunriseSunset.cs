...
using System;
    ...
    /// sunset times. Based on code from Sunriset.c, which was released to
    /// the public domain by Paul Schlyter, December 1992. Converted to
    /// Java and C# by Peter O., 2013.</summary>
public sealed class SunriseSunset {
  ...
  // **
  {
    ...
    sin_sdecl = Math.Sin(valueDEGRAD * obl_ecl) * Math.Sin(valueDEGRAD * slon);
