...
namespace com.upokecenter.util {
 ...
 return str;  // return early if there are no percent decodings
  ...
  { retString.Append((char)ret);
    ...
    /// <exception cref='ArgumentException'>Input contains a non-ASCII
    /// character.</exception>
    public static IList<string[]> ParseQueryString(
      string input,
      string delimiter) {
 ...
 return true;
    ...
    string indexString = Convert.ToString(
  index,
 ...
 private static IList<Object> ConvertToList(IDictionary<string, Object>
  ...
  CultureInfo.InvariantCulture);
    ...
    /// <param name='delimiter'>Not documented yet.</param>
    /// <returns>An IDictionary(string, Object) object.</returns>
    public static IDictionary<string, Object> QueryStringToDict(
  string query,
  string delimiter) {
