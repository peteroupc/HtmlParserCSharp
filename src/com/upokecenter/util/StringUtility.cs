...
public sealed class StringUtility {
   ...
   * sole element is the empty _string.
   */
  ...
  public static bool startsWith(string str, string prefix, int index){
    ...
    return str.Substring(index,(endpos)-(index)).Equals(prefix);
  }

  /**
   * Returns a _string with all ASCII upper-case letters
  ...
  /**
   * Returns a _string with all ASCII lower-case letters
