...
public sealed class URL {
 ...
 return false;
   ...
   (c >= 0xfdf0 && c <= 0xffef) || (c >= 0x10000 && c <= 0x10fffd)) ? (true) :
          (false);
  }
 ...
 return null;
        ...
        if (!(baseurl.scheme.Equals("http") || baseurl.scheme.Equals("https") ||
            baseurl.scheme.Equals("ftp") || baseurl.scheme.Equals("gopher") ||
            baseurl.scheme.Equals("ws") || baseurl.scheme.Equals("wss") ||
        ...
        if (c=='@') {
          ...
          for (int i = 0;i<buffer.Count; ++i) {
            ...
            if ((!isUrlCodePoint(c) && c!='%') || (cp=='%' &&
                (i + 3>buffer.Count || !isHexDigit(array[index + 1]) ||
 ...
 return !username.Equals(other.username);
  ...
  public string getHost() {
    return (port.Length == 0) ? (hostSerialize(host)) : (hostSerialize(host) +
      ":" + port);
  }
 ...
 return path;
  ...
  public override sealed int GetHashCode() {
     var prime = 31;
    int result = prime * result + ((fragment == null) ? 0 :
  ...
  public override sealed string ToString() {
    ...
    if (scheme.Equals("file") || scheme.Equals("http") ||
        ...
        scheme.Equals("gopher") || scheme.Equals("ws") ||
        scheme.Equals("wss")) {
