...
using System.Text;
    ...
    /// <summary>An _object represented in BEncode, a serialization format
    /// used in the BitTorrent protocol. For more information, see:
    /// https://wiki.theory.org/BitTorrentSpecification#bencoding This
    /// class accepts BEncoded strings in UTF-8, and outputs BEncoded
    /// strings in UTF-8.</summary>
public sealed class BEncodeObject {
    /// <summary>Creates a new BEncoded _object as an empty
    /// dictionary.</summary>
    /// <returns>A BEncodeObject object.</returns>
  public static BEncodeObject newDictionary() {
    return new BEncodeObject(new
      PeterO.Support.LenientDictionary<string, BEncodeObject>());
  }

  private Object obj = null;
  public const int TYPE_INTEGER = 0;
  public const int TYPE_STRING = 1;
  public const int TYPE_LIST = 2;

  public const int TYPE_DICTIONARY = 3;

  public static BEncodeObject fromByteArray(byte[] buf) {
    return fromByteArray(buf, 0, buf.Length);
  }

    /// <summary>Gets a BEncoded _object from parsing a byte array of data
    /// in BEncoding. @param buf @param off @param len @ if an error occurs
    /// when parsing the _object.</summary>
 ...
 return -1;
    ...
    /// <summary>Creates a new BEncoded _object as an empty list.</summary>
    /// <returns>A BEncodeObject object.</returns>
  public static BEncodeObject newList() {
    return new BEncodeObject(new List<BEncodeObject>());
  }

    /// <summary>Parses a BEncoded _object from an input stream. @param
    /// stream An input stream. This stream must support marking. @return A
    /// BEncoded _object. @ if marking is not supported on the supplied
    /// stream. @ if an I/O error occurs.</summary>
 ...
 throw new ArgumentException();
  ...
  private static IDictionary<string, BEncodeObject>
    readDictionary(PeterO.Support.InputStream stream) {
    IDictionary<string, BEncodeObject> map = new
      PeterO.Support.LenientDictionary<string, BEncodeObject>();
    while (true) {
      stream.mark(2);
 ...
 return 0;
    ...
    try {
      ...
      return
  Int64.Parse(retstr, NumberStyles.AllowLeadingSign, CultureInfo.InvariantCulture);
    } catch (FormatException) {
throw new BEncodeException(negative ? "Integer too small" :
        "Integer too big");
    }
  }
  private static IList<BEncodeObject> readList(PeterO.Support.InputStream
    stream) {
 ...
 throw new BEncodeException("Colon expected");
  ...
  private static string readUtf8(PeterO.Support.InputStream stream, int
    byteLength) {
 ...
 throw new BEncodeException("Invalid UTF-8");
    ...
    /// <summary>* Gets a BEncoded _object with the value of the given
    /// integer. @param value A 32-bit integer.</summary>
  ...
  public static BEncodeObject valueOf(int value) {
    ...
    /// <summary>* Gets a BEncoded _object with the value of the given
    /// long. @param value A 64-bit integer.</summary>
    /// <param name='value'>Not documented yet.</param>
    /// <returns>A BEncodeObject object.</returns>
  public static BEncodeObject valueOf(long value) {
    ...
    /// <summary>Gets a BEncoded _object with the value of the given
    /// _string. @param value A _string. Cannot be null.</summary>
    /// <param name='value'>Not documented yet.</param>
    /// <returns>A BEncodeObject object.</returns>
 ...
 throw new ArgumentException();
  ...
  public void add(string value) {
    ...
    /// <summary>Creates a shallow copy of this _object. For lists and
    /// dictionaries, the values of the new copy are the same as those of
    /// this _object; they are not copies. @return If this is a dictionary
    /// or list, then a new BEncoded _object with the same type as this
    /// _object. If this is a _string or integer, then returns this
    /// _object.</summary>
    /// <returns>A BEncodeObject object.</returns>
 ...
 return beo;  // integer and _string objects are immutable
  ...
  public BEncodeObject this[int i] { get {
 return get(i);
} set { set(i, value); } }
public BEncodeObject get(int key) {
    return getList()[key];
  }
  public BEncodeObject this[string i] { get {
 return get(i);
} set { put(i, value); } }
public BEncodeObject get(string key) {
  ...
  public IDictionary<string, BEncodeObject> getDictionary() {
    ...
    /// <summary>Gets the integer represented by this _object, if possible.
    /// @return the 32-bit integer for this _object. @ if this _object
    /// isn't an Integer or its value exceeds the range of int.</summary>
 ...
 throw new InvalidCastException();
  ...
  public IList<BEncodeObject> getList() {
    ...
    /// <summary>Gets the long represented by this _object, if possible.
    /// @return the 64-bit integer for this _object. @ if this _object
    /// isn't a Long.</summary>
...
public int size() {
 ...
 return (obj is IList<BEncodeObject>) ? (((IList<BEncodeObject>)obj).Count):
   (0);
}
  }

  public byte[] toByteArray() {
    com.upokecenter.io.MemoryOutputStream os = new
      com.upokecenter.io.MemoryOutputStream();
    try {
      write(os);
    } catch (IOException e) {
      throw new BEncodeException("Internal error",e);
 ...
 throw new BEncodeException("invalid string");
  ...
  IDictionary<string, BEncodeObject>
        map=(IDictionary<string, BEncodeObject>)obj;
